      ...
      <div className="hero-content flex-col-reverse lg:flex-row-reverse relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-0">
        ...
        <div className="flex-1 relative min-h-[300px] sm:min-h-[400px] lg:min-h-[500px] w-full lg:pl-[100px]">
          ...
          <div className="block lg:hidden">
            ...
            <img
              src={MainBanner}
              className="floating-reverse w-48 h-48 sm:w-60 sm:h-60 rounded-full object-cover absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-xl z-10"
            />
            {/* Smaller decorative images around main image for mobile */}
            <img
              src={Banner1}
              className="sliding w-20 h-20 sm:w-24 sm:h-24 rounded-full object-cover absolute top-4 left-4 shadow-xl z-20"
            />
            <img
              src={Banner3}
              className="floating w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover absolute bottom-4 left-8 shadow-xl z-20"
            />
            <img
              src={Banner4}
              className="sliding w-18 h-18 sm:w-22 sm:h-22 rounded-full object-cover absolute top-8 right-4 shadow-xl z-20"
            />
            <img
              src={Banner5}
              className="floating w-14 h-14 sm:w-16 sm:h-16 rounded-full object-cover absolute bottom-8 right-8 shadow-xl z-20"
            />
            <img
              src={Banner2}
              className="floating-reverse w-16 h-16 sm:w-18 sm:h-18 rounded-full object-cover absolute top-20 right-12 shadow-xl z-10"
            />
          ...
          <div className="hidden lg:block">
            ...
            <img
              src={Banner1}
              className="sliding w-40 h-40 rounded-full object-cover absolute top-0 left-20 shadow-xl z-20"
            />
            {/* Image 2 */}
            <img
              src={MainBanner}
              className="floating-reverse w-[350px] h-[350px] rounded-full object-cover absolute top-20 left-40 shadow-xl z-10"
            />
            {/* Image 3 */}
            <img
              src={Banner3}
              className="floating w-36 h-36 rounded-full object-cover absolute top-80 left-15 shadow-xl z-20"
            />
            {/* Image 4 */}
            <img
              src={Banner4}
              className="sliding w-30 h-30 rounded-full object-cover absolute bottom-10 left-120 shadow-xl z-20"
            />
            <img
              src={Banner5}
              className="floating w-30 h-30 rounded-full object-cover absolute top-0 left-100 shadow-xl z-20"
            />
            <img
              src={Banner2}
              className="floating-reverse w-28 h-28 rounded-full object-cover absolute top-107 left-80 shadow-xl z-10"
            />
